...
const ARTICLES_REGISTRY: Record<string, Array<{
  ...
  // ── virtavo.com ────────────────────────────────────────────────
  // Verified live on store.virtavo.com (sitemap checked 2026-06-15)
  'virtavo.com': [
    { id: 1, title: 'Wi-Fi HaLow: The Game-Changing Technology Behind Next-Gen Remote Monitoring Cameras', slug: '/2025/07/25/wi-fi-halow-the-game-changing-technology-behind-next-generation-remote-monitoring-cameras/', keyword: 'wifi halow security camera', secondary: ['802.11ah security camera','long range wifi security camera','halow camera system','mileflask halow'], product: 'MileFlask', file: '', status: 'published', date: '2025-07-25' },
    { id: 2, title: 'Your Ultimate Guide to Choosing the Best Home Security Cameras for Your Family', slug: '/2025/07/18/your-ultimate-guide-to-choosing-the-best-home-security-cameras-for-your-family/', keyword: 'best home security cameras', secondary: ['home security camera guide','security camera buying guide','family home security'], product: 'WinEye', file: '', status: 'published', date: '2025-07-18' },
    // ── Planned (not yet published) ──
    { id: 3, title: 'Best Long-Range Security Camera with No Monthly Fees (2026 Guide)', slug: '/blog/long-range-security-camera-no-monthly-fee/', keyword: 'long range security camera no monthly fee', secondary: ['wifi halow security camera','1 mile range security camera','remote security camera no cell service'], product: 'MileFlask', file: '', status: 'ready', date: '2026-06-15' },
    { id: 4, title: 'Window Mounted Security Camera: The Complete Guide (2026)', slug: '/blog/window-mounted-security-camera-guide/', keyword: 'window mounted security camera', secondary: ['glass mounted camera','indoor security camera outdoor view','security camera through window'], product: 'WinEye', file: '', status: 'ready', date: '2026-06-15' },
    { id: 5, title: 'Best Security Camera for Renters: No Drilling, No Permission Needed (2026)', slug: '/blog/best-security-camera-for-renters/', keyword: 'security camera for renters', secondary: ['apartment security camera no drilling','no drill security camera','window security camera apartment'], product: 'WinEye', file: '', status: 'ready', date: '2026-06-15' },
  ],
  // ── mysnapvitals.com ────────────────────────────────────────
  'mysnapvitals.com': [
    ...
    { id: 2, title: "Understanding Your Blood Pressure Numbers: A Complete Senior's Guide", slug: '/blog/understanding-blood-pressure-numbers/', keyword: 'blood pressure numbers for seniors', secondary: ["understanding blood pressure readings", "systolic vs diastolic explained", "high blood pressure for elderly"], product: 'SnapVitals', file: '', status: 'published', date: '2026-01-09' },
    ...
    { id: 4, title: "Walking Your Way to Better Blood Pressure: A Senior's Exercise Guide", slug: '/blog/exercise-guide-seniors-blood-pressure/', keyword: 'walking for blood pressure', secondary: ["exercise for seniors blood pressure", "lower blood pressure exercise", "senior walking program blood pressure"], product: 'SnapVitals', file: '', status: 'published', date: '2026-01-15' },
    ...
    { id: 24, title: "Low Blood Pressure in Seniors: When \"Lower Is Better\" Isn't Always True", slug: '/blog/low-blood-pressure-seniors/', keyword: 'low blood pressure in seniors', secondary: ["hypotension elderly symptoms", "managing low blood pressure older adults", "what causes low blood pressure in older people"], product: 'SnapVitals', file: '', status: 'published', date: '2026-03-16' },
    ...
    { id: 30, title: "How Gardening Lowers Blood Pressure: Nature's Therapy for Seniors", slug: '/blog/gardening-seniors-blood-pressure/', keyword: 'gardening lowers blood pressure', secondary: ["garden therapy for seniors", "lower blood pressure naturally", "benefits of gardening for elderly"], product: 'SnapVitals', file: '', status: 'published', date: '2026-04-03' },
    { id: 31, title: "The Family Caregiver's Guide to Managing a Loved One's Blood Pressure", slug: '/blog/caregiver-guide-elderly-blood-pressure/', keyword: 'manage blood pressure elderly', secondary: ["caregiver blood pressure guide", "home blood pressure monitoring seniors", "how to help elderly with high blood pressure"], product: 'SnapVitals', file: '', status: 'published', date: '2026-04-06' },
    ...
    { id: 35, title: "Managing Blood Pressure While Traveling: A Senior's Complete Guide", slug: '/blog/blood-pressure-travel-tips/', keyword: 'blood pressure travel tips for seniors', secondary: ["traveling with hypertension seniors", "senior travel health", "managing blood pressure on vacation elderly"], product: 'SnapVitals', file: '', status: 'published', date: '2026-04-18' },
    ...
    { id: 42, title: "Resistant Hypertension: When Blood Pressure Won't Budge", slug: '/blog/resistant-hypertension-treatment/', keyword: 'resistant hypertension', secondary: ["high blood pressure medication", "uncontrolled blood pressure", "hypertension treatment options"], product: 'SnapVitals', file: '', status: 'published', date: '2026-05-09' },
    ...
    { id: 87, title: "Managing Blood Pressure With Kidney Disease: A Senior's Complete Guide", slug: '/blog/walking-lower-blood-pressure-seniors/', keyword: '', secondary: [], product: 'SnapVitals', file: '', status: 'published', date: '2026-05-22' },
    ...
    { id: 109, title: "How Accurate Are Home Blood Pressure Monitors? A Guide for Seniors", slug: '/blog/ocr-blood-pressure-scanner-app/', keyword: '', secondary: [], product: 'SnapVitals', file: '', status: 'published', date: '2026-06-10' },
    { id: 110, title: "The Essential Guide to Monitoring Elderly Parents' Blood Pressure Remotely", slug: '/blog/blood-pressure-monitor-accuracy-test/', keyword: '', secondary: [], product: 'SnapVitals', file: '', status: 'published', date: '2026-06-11' },
  ],
}
